...
class rx_ofdm(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(
            gr.sizeof_char * 1, "rx_payload.bin", False
        )
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0 = blocks.delay(
            gr.sizeof_gr_complex * 1, (fft_len + fft_len // 4)
        )
        ...
        ##################################################
        self.msg_connect(
            (self.digital_packet_headerparser_b_0, "header_data"),
            (self.digital_header_payload_demux_0, "header_data"),
        )
        self.connect(
            (self.analog_frequency_modulator_fc_0, 0), (self.blocks_multiply_xx_0, 0)
        )
        self.connect((self.blocks_delay_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect(
            (self.blocks_multiply_xx_0, 0), (self.digital_header_payload_demux_0, 0)
        )
        ...
        self.connect(
            (self.digital_ofdm_sync_sc_cfb_0, 1),
